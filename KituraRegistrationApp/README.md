...
1. `swift build`
1. `.build/debug/KituraRegistrationApp`
...
* `docker run -it -p 8080:8080 -v $PWD:/root/project -w /root/project myapp-run sh -c .build-ubuntu/release/KituraRegistrationApp`
